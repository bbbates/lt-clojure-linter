...
lt.plugins.lt_clojure_linter.__GT_linter_result = (function __GT_linter_result(p__21475){var map__21477 = p__21475;var map__21477__$1 = ((cljs.core.seq_QMARK_.call(null,map__21477))?cljs.core.apply.call(null,cljs.core.hash_map,map__21477):map__21477);var res = map__21477__$1;var alt = cljs.core.get.call(null,map__21477__$1,new cljs.core.Keyword(null,"alt","alt",1014000923));return cljs.core.assoc.call(null,res,new cljs.core.Keyword(null,"message","message",1968829305),[cljs.core.str("Consider using: "),cljs.core.str(alt)].join(''));
});
...
lt.plugins.lt_clojure_linter.bg_expr_check = lt.plugins.lt_clojure_linter.threads.pool_thread_STAR_.call(null,lt.plugins.lt_clojure_linter.thread_pool,(function tfun21478(){var orig__21312__auto__ = argsArray(arguments);var msg__21313__auto__ = orig__21312__auto__.shift();var args__21314__auto__ = orig__21312__auto__.map(cljs.reader.read_string);var raise = ((function (orig__21312__auto__,msg__21313__auto__,args__21314__auto__){
...
return (function (obj_id,expr_checker_module,editor_text,file_name){delete require.cache[expr_checker_module];
var lt__$1 = require(expr_checker_module);return raise.call(null,obj_id,new cljs.core.Keyword(null,"exprs-check-complete","exprs-check-complete",4114379871),lt.plugins.lt_clojure_linter.expr_checker.lint_editor_text(editor_text,file_name));
